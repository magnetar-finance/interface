...
function composeBytes(tokenId: bigint, amount: bigint) {
...
function useSplitLock(
  ...
  const composition = useMemo(() => composeBytes(tokenId, amount), [tokenId, amount]);
