...
function composeBytes(pools: Address[], weights: bigint[]) {
...
function useRentalVote(
  ...
  const composition = useMemo(() => composeBytes(pools, weights), [pools, weights]);
